...
<div class = "menuContentBox">
   <!--Contenitore per il menu con i relativi link per le altre pagine del sito-->
	...
	<?php
		...
		$str = "<div class = 'titlebox'>Add Event<br/></div>";
		echo $str;
		if(isset($_GET['err']) === true)
			echo "Inserisci i valori obbligatori";
		$str ="<form name = 'modify' action = 'saveNuovoEvento.php' method = 'POST'>
    	<label>Titolo evento*:</label>
   		<textarea name = 'titolo' rows 1></textarea><br/><br/>
    	<label>Descrizione:</label>
    	<textarea name = 'descrizione' rows = 10></textarea><br/><br/>
        <label>Data*:</label>
